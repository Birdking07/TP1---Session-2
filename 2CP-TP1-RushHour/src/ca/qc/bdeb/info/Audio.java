    ...
    private boolean load() {
        ...
        try {
            ...
            for (int i = 0; i < NB_CLIPS; i++) {
                ...
                filename = switch (i) {
                    case BACKGROUND -> "412009__ghrockotron3000__thinking-music.wav";
                    case SOLVED -> "320657__rhodesmas__level-up-03.wav";
                    case BORDER -> "342756__rhodesmas__failure-01.wav";
                    case VEHICLE -> "26186__fogma__my-car-horn-beep.wav";
                    default -> "";
                };
